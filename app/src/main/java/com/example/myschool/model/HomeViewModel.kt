...
class HomeViewModel(private val repositoriJadwalSiswa: RepositoriJadwalSiswa) : ViewModel() {
    ...
    val homeUiState: StateFlow<HomeUiState> = repositoriJadwalSiswa.getAllSiswaStream()
        .filterNotNull()
